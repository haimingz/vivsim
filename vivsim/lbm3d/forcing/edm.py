...
def forcing_edm(f, g, u):
    ...
    distributions evaluated at force-density-shifted velocities. In this
    implementation, the result is written in the algebraically equivalent form

    ``get_guo_forcing_term(g, u)``.
