"""Geometry helpers for 3D immersed-boundary surface meshes."""
...
def get_area(vertex_coords, faces):
    """Compatibility alias for total surface area."""

    return get_surface_area(vertex_coords, faces)
